...
public class ImportantQuestionsTest {
    ...
    public ImportantQuestionsTest(String importantQuestionText, String answerText) {
    ...
    public void checkImportantQuestionsList_textAnswerIsDisplayedCorrectly_AfterClick () {
        ...
        Assert.assertTrue(page.clickImportantQuestion(importantQuestionText, answerText));
